...
export function LeaderboardTable({ entries }: Props) {
  ...
  const getMetalBadge = (index: number) => {
    if (index === 0) {
      ...
      return (
        <div
          className="ml-3 flex h-7 w-7 items-center justify-center rounded-full bg-gradient-to-br from-yellow-300 via-amber-400 to-yellow-600 text-[11px] font-bold text-amber-950 shadow-inner ring-1 ring-yellow-400/60"
    ...
    if (index === 1) {
      ...
      return (
        <div
          className="ml-3 flex h-7 w-7 items-center justify-center rounded-full bg-gradient-to-br from-slate-200 via-slate-300 to-slate-400 text-[11px] font-bold text-slate-700 shadow-inner ring-1 ring-slate-300/60"
    ...
    if (index === 2) {
      ...
      return (
        <div
          className="ml-3 flex h-7 w-7 items-center justify-center rounded-full bg-gradient-to-br from-orange-300 via-amber-500 to-orange-700 text-[11px] font-bold text-amber-100 shadow-inner ring-1 ring-orange-400/60"
